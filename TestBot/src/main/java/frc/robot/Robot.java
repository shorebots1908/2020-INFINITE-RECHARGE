...
public void Update_Limelight_Tracking()
  {
        ...
        final double turn = 0.03;                    // how hard to turn toward the target
        final double forward = 0.26;                    // how hard to drive fwd toward the target
        ...
        double drive_cmd = (DESIRED_TARGET_AREA - ta) * forward;
